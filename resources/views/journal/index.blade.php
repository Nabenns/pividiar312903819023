    ...
    <div class="py-12" x-data="{ showModal: false }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <button @click="showModal = true" class="bg-brand-orange hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg shadow-brand-orange/20 transition-all transform hover:-translate-y-1 flex items-center gap-2">
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-[#0A1935] border border-white/10 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                    <form action="{{ route('journal.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="px-6 py-6">
                            <h3 class="text-xl font-bold text-white mb-6">Record New Trade</h3>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Pair</label>
                                    <input type="text" name="pair" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="BTC/USDT">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Date</label>
                                    <input type="date" name="trade_date" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Direction</label>
                                    <select name="direction" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="leverage" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="20">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Entry Price</label>
                                    <input type="number" step="any" name="entry_price" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Exit Price</label>
                                    <input type="number" step="any" name="exit_price" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Margin (USDT)</label>
                                    <input type="number" step="any" name="margin" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Status</label>
                                    <select name="status" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="any" name="pnl_value" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="-50.00">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">PnL Percentage (%)</label>
                                    <input type="number" step="any" name="pnl_percentage" required class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="-25.5">
                                </div>
                                <div class="md:col-span-2">
                                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Notes</label>
                                    <textarea name="notes" rows="3" class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:border-brand-orange focus:ring-1 focus:ring-brand-orange" placeholder="Why did you take this trade?"></textarea>
                                </div>
                            </div>
                        </div>
